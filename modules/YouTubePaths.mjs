...
export const SEARCH__RESULTS_NEXT_CONTENTS      = "data.onResponseReceivedCommands[0].appendContinuationItemsAction.continuationItems";
...
export const PLAYLIST__RESULTS_NEXT_CONTENTS    = "data.onResponseReceivedActions[0].appendContinuationItemsAction.continuationItems";
...
export const CHANNEL__RESULTS_NEXT_CONTENTS     = "data.onResponseReceivedActions[0].appendContinuationItemsAction.continuationItems";
...
export const COLLECTION__RESULTS_NEXT_CONTENTS  = "data.onResponseReceivedActions[0].appendContinuationItemsAction.continuationItems";
...
export const SUGGESTED__RESULTS_NEXT_CONTENTS   = "data.onResponseReceivedEndpoints[0].appendContinuationItemsAction.continuationItems";
...
export const HOME__RESULTS_NEXT_CONTENTS        = "data.onResponseReceivedActions[0].appendContinuationItemsAction.continuationItems";
